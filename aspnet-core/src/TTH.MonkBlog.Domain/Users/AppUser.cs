...
namespace TTH.MonkBlog.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. update MonkBlogDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MonkBlogEfCoreEntityExtensionMappings to extend the IdentityUser entity
